...
export default function Header() {
  return (
    <header className='border-b bg-white font-[sans-serif] tracking-wide relative z-50'>
      <section className='py-3 bg-[#000000] text-white text-center px-10 relative mb-6'> {/* Adjust mb-6 here for more space */}
        <p className='text-sm'>
      ...
      <div className='flex flex-wrap items-center gap-5 w-full'>
          ...
          <ul className='lg:flex lg:ml-14 lg:gap-x-5 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
            <li className='mb-6 hidden max-lg:block'>
              <Link href="javascript:void(0)">
                <Image src="https://readymadeui.com/readymadeui.svg" alt="logo" width={144} height={36} />
              </Link>
            </li>
        ...
        <div className="flex items-center gap-x-6 gap-y-4 ml-auto">
          ...
          <div className='flex lg:ml-auto max-lg:w-full items-center justify-center gap-1'>
            <Link href={"/cart"}>
              <Image src={Frame} alt="Cart" width={20} height={20} />
            </Link>
          </div>
          <div>
            <Image src={Frame1} alt="Cart" width={25} height={25} />
          </div>
        </div>
      </div>
    </header>
