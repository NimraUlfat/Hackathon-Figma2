            ...
            <div className="grid md:grid-cols-3 gap-4 mt-8">
                <div className="md:col-span-2 space-y-4">
                    ...
                    <div className="flex gap-4 bg-white px-4 py-6 rounded-md shadow-[0_2px_12px_-3px_rgba(6,81,237,0.3)]">
                        <div className="flex gap-4">
                            <div className="w-28 h-28 max-sm:w-24 max-sm:h-24 shrink-0">
                                <Image src={Frame56} alt="img" className="w-full h-full object-contain" />
                            </div>

                            <div className="flex flex-col gap-4">
                                <div>
                                    <h3 className="text-base font-bold text-gray-800">Gradient Graphic T-shirt</h3>
                                    <p className="text-sm font-semibold text-gray-500 mt-2 flex items-center gap-2">Size: Large</p>
                                    <p className="text-sm font-semibold text-gray-500 mt-2 flex items-center gap-2">Color: White</p>
                                </div>
                    ...
                    <div className="flex gap-4 bg-white px-4 py-6 rounded-md shadow-[0_2px_12px_-3px_rgba(6,81,237,0.3)]">
                        <div className="flex gap-4">
                            <div className="w-28 h-28 max-sm:w-24 max-sm:h-24 shrink-0">
                                <Image src={Frame34} alt="img" className="w-full h-full object-contain" />
                            </div>

                            <div className="flex flex-col gap-4">
                                <div>
                                    <h3 className="text-base font-bold text-gray-800">CHECKERED SHIRT</h3>
                                    <p className="text-sm font-semibold text-gray-500 mt-2 flex items-center gap-2">Size: Medium</p>
                                    <p className="text-sm font-semibold text-gray-500 mt-2 flex items-center gap-2">Color: Red</p>
                                </div>
                    ...
                    <div className="flex gap-4 bg-white px-4 py-6 rounded-md shadow-[0_2px_12px_-3px_rgba(6,81,237,0.3)]">
                        <div className="flex gap-4">
                            <div className="w-28 h-28 max-sm:w-24 max-sm:h-24 shrink-0">
                                <Image src={Frame381} alt="img" className="w-full h-full object-contain" />
                            </div>

                            <div className="flex flex-col gap-4">
                                <div>
                                    <h3 className="text-base font-bold text-gray-800">SKINNY FIT JEANS</h3>
                                    <p className="text-sm font-semibold text-gray-500 mt-2 flex items-center gap-2">Size: Large</p>
                                    <p className="text-sm font-semibold text-gray-500 mt-2 flex items-center gap-2">Color: Blue</p>
                                </div>
